...
\midrule
Funding dependency & \begin{minipage}[t]{0.6\textwidth}\begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
    \item Maintain 12-month cash runway
    \item Develop revenue-based financing options
    \item Build relationships with 20+ investors
    \item Achieve cash flow positive by Month 18
\end{itemize}\end{minipage} \\
\midrule
CAC management & \begin{minipage}[t]{0.6\textwidth}\begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
    \item Diversify acquisition channels
    \item Invest in organic/content marketing
    \item Implement referral programme
    \item Target CAC:CLV ratio of 1:4
\end{itemize}\end{minipage} \\
\midrule
Currency exposure & \begin{minipage}[t]{0.6\textwidth}\begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
    \item Natural hedging through costs
    \item Forward contracts for major exposures
    \item Multi-currency pricing strategy
    \item Regular FX risk assessment
\end{itemize}\end{minipage} \\
\bottomrule
\end{tabular}
...
\begin{tikzpicture}[node distance=2.5cm]
    ...
    % Security layers
    \node[rectangle,draw=corporate-blue,fill=corporate-lightgrey,align=center,above of=center] (prevent) {Prevention\\WAF, DDoS Protection};
    \node[rectangle,draw=corporate-blue,fill=corporate-lightgrey,align=center,right of=center] (detect) {Detection\\SIEM, Monitoring};
    \node[rectangle,draw=corporate-blue,fill=corporate-lightgrey,align=center,below of=center] (respond) {Response\\Incident Team};
    \node[rectangle,draw=corporate-blue,fill=corporate-lightgrey,align=center,left of=center] (recover) {Recovery\\Backups, DR};
...
\begin{tikzpicture}
    % Overall risk status
    \node[rectangle,draw=corporate-blue,fill=corporate-lightblue!30,minimum width=12cm,minimum height=2cm,align=center] at (0,5) {
            \Large\textbf{Overall Risk Status: MEDIUM}\\
            \small Last Updated: \today
        };

    % Risk category status boxes
    \node[rectangle,draw=accent-green,fill=accent-green!20,minimum width=3.5cm,minimum height=2cm,align=center] at (-4,2) {
            \textbf{Strategic}\\
            \small 2 High, 3 Medium\\
            Trend: Stable
        };

    \node[rectangle,draw=accent-orange,fill=accent-orange!20,minimum width=3.5cm,minimum height=2cm,align=center] at (0,2) {
            \textbf{Financial}\\
            \small 1 High, 4 Medium\\
            Trend: Improving
        };

    \node[rectangle,draw=accent-red,fill=accent-red!20,minimum width=3.5cm,minimum height=2cm,align=center] at (4,2) {
            \textbf{Technology}\\
    ...
    % Action items
    \node[rectangle,draw=corporate-grey,fill=corporate-lightgrey,minimum width=10cm,minimum height=2cm,align=center] at (0,-1) {
            \textbf{Critical Actions Required}\\
            \small
            \begin{minipage}[t]{0.8\textwidth}
            \begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
                \item Complete Series A funding by Q2
                \item Implement enhanced security measures
                \item Finalise key hire succession plans
            \end{itemize}
            \end{minipage}
        };
\end{tikzpicture}
...
\midrule
Detection (0-1 hour) & \begin{minipage}[t]{10cm}\begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
...
\end{itemize}\end{minipage} \\
\midrule
Assessment (1-4 hours) & \begin{minipage}[t]{10cm}\begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
...
\end{itemize}\end{minipage} \\
\midrule
Response (4-24 hours) & \begin{minipage}[t]{10cm}\begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
...
\end{itemize}\end{minipage} \\
\midrule
Recovery (1-7 days) & \begin{minipage}[t]{10cm}\begin{itemize}[leftmargin=*,noitemsep,label=\textbullet]
