...
We offer bespoke corporate packages designed for small, focused teams. These packages are tailored to the specific needs of the organisation and are priced based on the curriculum, duration, and required resources. Example packages include:
\begin{itemize}
    \item \textbf{Starter Package}: A 3-day intensive for a team of 3-6, focusing on core concepts.
    \item \textbf{Professional Package}: A 5-day deep-dive for a team of 3-6, combining multiple disciplines.
    \item \textbf{Enterprise Solution}: A fully customised, multi-week program with ongoing support and certification.
\end{itemize}
Pricing is determined upon consultation, starting from \pounds{15,000}.
