...
DreamLab is situated on a 1.5-acre plot in Eskdale Green, Cumbria\index{Cumbria}\index{Eskdale Green}, offering:

\begin{itemize}
    \item Strategic location: 10 minutes from the Sellafield\index{Sellafield} nuclear site, providing a unique focus for engineering and simulation training.
    \item Inspiring natural environment within the Lake District National Park\index{Lake District National Park}, fostering creativity and focus.
    \item A unique blend of high-tech lab space and comfortable, modern accommodation.
    \item High-speed fiber connectivity (10Gbps) enabling global collaboration.
    \item A secure, private campus ideal for residential programs.
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{media/aerialView.png}
    \caption{Aerial view of the DreamLab campus in Eskdale Green.}
    \label{fig:aerial-view}
\end{figure}

\subsection{Virtual Production Facility\index{Virtual Production}}

\subsubsection{LED Volume Stage\index{LED Volume}}
...
\subsubsection{Motion Capture Studio\index{Motion Capture}}
...
\subsubsection{Gaussian Splatting \& Neural Rendering Lab\index{Gaussian Splatting}\index{Neural Rendering}}
...
\subsubsection{Telepresence \& XR Laboratory\index{Telepresence}\index{XR (Extended Reality)}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{media/labview3.png}
    \caption{The Engineering Simulation and Visualization Suite.}
    \label{fig:lab-view-3}
\end{figure}
...
The renovated Cumbrian property combines traditional charm with cutting-edge technology:
