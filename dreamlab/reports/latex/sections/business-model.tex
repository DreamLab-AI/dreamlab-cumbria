...
\midrule
3-Day Bootcamp & \pounds{1,495} & 6 & Weekly & 40 & \pounds{358,800} \\
2-Day Workshop & \pounds{995} & 6 & Bi-weekly & 20 & \pounds{119,400} \\
5-Day Intensive & \pounds{2,995} & 6 & Monthly & 10 & \pounds{179,700} \\
Corporate Package & \pounds{25,000} & Team & Monthly & 12 & \pounds{300,000} \\
\midrule
\multicolumn{5}{r}{\textbf{Total Training Revenue (Year 3):}} & \textbf{\pounds{957,900}} \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Sellafield supply chain and North West industry events
...
\begin{itemize}
    ...
    \item \textbf{Government Contracts}: National / Regional skills programmes
\end{itemize}
...
\midrule
Average Transaction Value & \pounds{1,995} & \pounds{225}/night \\
Customer Acquisition Cost & \pounds{250} & \pounds{55} \\
Gross Margin & 75\% & 85\% \\
Customer Lifetime Value & \pounds{9,500} & \pounds{1,500} \\
Payback Period & 1.5 months & 1.0 months \\
\bottomrule
\end{tabular}
\end{table}