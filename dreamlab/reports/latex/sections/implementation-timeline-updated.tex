...
\begin{ganttchart}[
    ...
    \ganttbar[name=facility]{Facility Setup}{1}{2} \\
    \ganttbar[name=team]{Team Recruitment}{1}{2} \\
    \ganttbar[name=equip]{Equipment Order}{2}{3} \\
    \ganttmilestone[name=ready]{Facility Ready}{3} \\
    \ganttgroup{Phase 2: Launch}{4}{6} \\
    \ganttbar[name=install]{Equipment Install}{4}{5} \\
    \ganttbar[name=dev]{Program Development}{3}{5} \\
    \ganttbar[name=market]{Marketing Campaign}{4}{6} \\
    \ganttmilestone[name=course]{First Course}{6} \\
    \ganttgroup{Phase 3: Growth}{7}{9} \\
    \ganttbar[name=expand]{Course Expansion}{7}{9} \\
    \ganttbar[name=partner]{Partnership Building}{6}{9} \\
    \ganttbar[name=online]{Online Platform}{7}{9} \\
    \ganttmilestone[name=ops]{Full Operations}{9} \\
    \ganttgroup{Phase 4: Scale}{10}{12} \\
    \ganttbar[name=advanced]{Advanced Programs}{10}{12} \\
    \ganttbar[name=corp]{Corporate Training}{10}{12} \\
    \ganttbar[name=cert]{Certification Launch}{11}{12} \\
    \ganttmilestone[name=y1]{Year 1 Complete}{12}
\end{ganttchart}
\end{center}
...
\begin{tikzpicture}[scale=0.8]
    ...
    \node[rectangle, draw=dreamlab-purple, fill=dreamlab-purple!20, above=0.5cm of install] {LED Volume};
    \draw[thick, dreamlab-purple] (install.west)++(0,0.5) -- (install.east)++(0,0.5);

    \node[rectangle, draw=dreamlab-blue, fill=dreamlab-blue!20, above=1.5cm of dev] {MoCap Studio};
    \draw[thick, dreamlab-blue] (dev.west)++(0,1.5) -- (dev.east)++(0,1.5);

    \node[rectangle, draw=dreamlab-green, fill=dreamlab-green!20, above=2.5cm of market] {Agentic Lab};
    \draw[thick, dreamlab-green] (market.west)++(0,2.5) -- (market.east)++(0,2.5);

    \node[rectangle, draw=dreamlab-orange, fill=dreamlab-orange!20, above=0.5cm of expand] {Gaussian Rig};
    \draw[thick, dreamlab-orange] (expand.west)++(0,0.5) -- (expand.east)++(0,0.5);

    \node[rectangle, draw=dreamlab-grey, fill=dreamlab-grey!20, above=1.5cm of online] {Online Platform};
    \draw[thick, dreamlab-grey] (online.west)++(0,1.5) -- (online.east)++(0,1.5);
\end{tikzpicture}
\end{center}
