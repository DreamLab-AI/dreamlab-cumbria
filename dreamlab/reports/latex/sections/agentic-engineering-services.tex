...
\textbf{Introduction to Agentic Engineering} (3 days)
\begin{itemize}
...
\begin{trainingpackage}
\textbf{Advanced Multi-Agent Systems} (5 days)
\begin{itemize}
...
\begin{trainingpackage}
\textbf{Agentic Workflow Automation} (4 days)
\begin{itemize}
...
\begin{trainingpackage}
\textbf{Creative AI Agents for Production} (3 days)
\begin{itemize}
